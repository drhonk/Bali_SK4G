...
#define LED0	S5PV210_GPD0(3) // SVC_LED1_RED
#define LED1	S5PV210_GPD0(2) // SVC_LED1_BLUE
#define LED2	S5PV210_GPB(6) // SVC_LED2_RED
#define LED3	S5PV210_GPA0(6) // SVC_LED2_GREEN
