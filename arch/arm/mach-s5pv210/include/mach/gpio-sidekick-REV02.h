...
#define GPIO_LED2_GREEN			S5PV210_GPA0(6)
...
#define GPIO_LED2_RED				S5PV210_GPB(6)
...
#define GPIO_LED1_BLUE			S5PV210_GPD0(2)
//#define GPIO_VIBTONE_PWM1		S5PV210_GPD0(2)

#define GPIO_LED1_RED			S5PV210_GPD0(3)
...
#define GPIO_OJ_SDA_28V			S5PV210_GPD1(2)
//#define GPIO_FM_SDA_28V			S5PV210_GPD1(2)
//#define GPIO_FM_SDA_28V_AF		2


#define GPIO_OJ_SCL_28V			S5PV210_GPD1(3)
#define GPIO_OJ_SCL_28V_AF		2
...
#define GPIO_GPS_CLK_INT		0	//S5PV210_GPG3(2)

#define GPIO_TA_CURRENT_SEL_AP	S5PV210_GPG3(3)

#define GPIO_BT_WAKE			S5PV210_GPG3(4)

#define GPIO_CAM_MEGA_EN		S5PV210_GPG3(5)
#define GPIO_WLAN_WAKE		0	//S5PV210_GPG3(5)
#define GPIO_WLAN_WAKE_AF		0	//	1

#define GPIO_CAM_MEGA_nRST		S5PV210_GPG3(6)
#define GPIO_LCD_BL_EN			0 //S5PV210_GPG3(6)
...
#define GPIO_T_FLASH_DETECT		S5PV210_GPH1(2)
#define GPIO_T_FLASH_DETECT_IRQ		IRQ_EINT10
...
#define GPIO_KBR4				S5PV210_GPH3(4)
#define GPIO_KBR4_AF

#define GPIO_KBR5				S5PV210_GPH3(5)
#define GPIO_KBR5_AF

#define GPIO_KBR6				S5PV210_GPH3(6)
#define GPIO_KBR6_AF

#define GPIO_OK_KEY				S5PV210_GPH3(7)
...
#define GPIO_MICBIAS_EN2		S5PV210_GPJ0(6) //hdlnc_ysyim_2010-05-04: from SGH-T959 REV0.5(HWREV = 0x0e)	 or 0.6 (HWREV = 0x0f)			
...
#define GPIO_QWERTY_BL_EN		S5PV210_GPJ1(2)
...
#define GPIO_KBC0				S5PV210_GPJ1(5)
#define GPIO_KBC0_AF			3

#define GPIO_KBC1				S5PV210_GPJ2(1)
#define GPIO_KBC1_AF			3
//#define GPIO_CAM_FLASH_EN		S5PV210_GPJ2(0)

#define GPIO_KBC2				S5PV210_GPJ2(2)
#define GPIO_KBC2_AF			3
//#define GPIO_CAM_FLASH_SET		S5PV210_GPJ2(1)

#define GPIO_KBC3				S5PV210_GPJ2(3)
#define GPIO_KBC3_AF			3
//#define GPIO_OLED_DET			S5PV210_GPJ2(2)

#define GPIO_KBC4				S5PV210_GPJ2(3)
#define GPIO_KBC4_AF			3
//#define GPIO_CODEC_XTAL_EN		S5PV210_GPJ2(3)

#define GPIO_KBC5				S5PV210_GPJ2(4)
#define GPIO_KBC5_AF			3

#define GPIO_FM_INT				0	//S5PV210_GPJ2(4)

#define GPIO_KBC6				S5PV210_GPJ2(5)
#define GPIO_KBC6_AF			3
#define GPIO_FM_RST				0	//S5PV210_GPJ2(5)

#define GPIO_KBC7				S5PV210_GPJ2(6)
#define GPIO_KBC7_AF			3

#define GPIO_MASSMEMORY_EN		S5PV210_GPJ2(7)

#define GPIO_ALS_SDA_28V		S5PV210_GPJ3(0)
#define _3_TOUCH_SDA_28V		0	//S5PV210_GPJ3(0)
#define GPIO_EARPATH_SEL		S5PV210_GPJ3(1)
#define _3_TOUCH_SCL_28V		0	//S5PV210_GPJ3(1)
#define GPIO_ALS_SCL_28V		S5PV210_GPJ3(2)
#define _3_GPIO_TOUCH_EN		0	//S5PV210_GPJ3(2)

#define GPIO_OJ_MOTION_C			S5PV210_GPJ3(3)
#define _3_GPIO_TOUCH_EN_AF		1
#define _3_GPIO_TOUCH_CE			0	//S5PV210_GPJ3(3)
...
#define  _3_GPIO_TOUCH_INT	0	//S5PV210_GPJ4(1)
#define _3_GPIO_TOUCH_INT_AF	0	//S3C_GPIO_SFN(0xf)
...
#define GPIO_DISPLAY_CS_H			S5PV210_MP01(1)
#define GPIO_DISPLAY_CS_H_AF		S3C_GPIO_SFN(1)
...
#define GPIO_USB_SEL			0	//S5PV210_MP04(0)
...
#define GPIO_DISPLAY_SDO			S5PV210_MP04(4)
#define GPIO_DISPLAY_SDO_AF		S3C_GPIO_SFN(1)

#define GPIO_DISPLAY_SDX			S5PV210_MP04(5)
#define GPIO_DISPLAY_SDX_AF		S3C_GPIO_SFN(1)
#else
...
#define GPIO_DISPLAY_CS_L		S5PV210_MP05(6)
#define GPIO_DISPLAY_CS_L_AF	S3C_GPIO_SFN(1)
...
#define	GPIO_TOUCH_RST	0	//		S5PV210_GPB(6)
