...
enum v4l2_zoom_level {
	...
	ZOOM_LEVEL_11,
	ZOOM_LEVEL_12,
#if defined(CONFIG_S5PC110_DEMPSEY_BOARD) || defined(CONFIG_S5PC110_CELOX_BOARD) //NAGSM_ANDROID_HQ_CAMERA_SUNGKOOLEE_20101119
	ZOOM_LEVEL_MAX = 31,
#else
	ZOOM_LEVEL_MAX,
#endif
...
#if defined(CONFIG_VIDEO_M5MO)
#define V4L2_CID_CAMERA_EV_PROGRAM_MODE			(V4L2_CID_PRIVATE_BASE+123) //NAGSM_ANDROID_HQ_CAMERA_SORACHOI_20101231 : EV-P for Scene Mode
#define V4L2_CID_CAMERA_MCC_MODE					(V4L2_CID_PRIVATE_BASE+124) //NAGSM_ANDROID_HQ_CAMERA_SORACHOI_20101231 : MCC for Scene Mode
#endif

//NAGSM_HQ_CAMERA_LEESUNGKOO_20101231 : to support two type front camera
// This is internal cmd fimc > camera driver.
#define V4L2_CID_CAM_FRONT_SENSOR_TYPE				(V4L2_CID_PRIVATE_BASE+125)
...
#define V4L2_CID_CAMERA_SENSOR_MODE							(V4L2_CID_PRIVATE_BASE+116)
#define V4L2_CID_CAMERA_SET_FLASH							(V4L2_CID_PRIVATE_BASE+117) //HDLNC_ANDROID_CAMERA_Mr.WOO_20101126
