...
#define FREQ_COUNT		87084/2  // 85884	/*89284*/  //85884 //
#elif defined(CONFIG_S5PC110_KEPLER_BOARD)
#define FREQ_COUNT		87084/2  // 87384
#elif defined(CONFIG_S5PC110_SIDEKICK_BOARD)
#define FREQ_COUNT		44342
#else
...
VibeInt8 nForce_last = 0; // [HSS] Fix vibtonz glitch
/*
...
#error Please review the code between the #if and #endif
	...
	{
		if(nForce_last  != nForce) // [HSS] Fix vibtonz glitch
		{
...
//	printk("[VIBETONZ] %s nForce: %d\n",__func__, nForce);
	nForce_last = nForce; // [HSS] Fix vibtonz glitch
