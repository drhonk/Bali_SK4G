...
static int ce147_load_fw(struct v4l2_subdev *sd)
{
	...
	printk(KERN_DEBUG "%s : vendor %d", __func__, CamVendorType);
...
static int ce147_get_fw_version(struct v4l2_subdev *sd)
{
	...
	if(state->fw.major == 0x05)
		...
		printk(KERN_DEBUG "There is no Vendor Type %d", state->fw.major);
...
//NAGSM_Android_HQ_LEESUNGKOO_20100823_START
#if defined(CONFIG_S5PC110_KEPLER_BOARD) || defined (CONFIG_S5PC110_FLEMING_BOARD) // TEMP for Fleming build_error
	unsigned char ce147_str_model[9] = "SGH-i897\0";
#endif
//NAGSM_Android_HQ_LEESUNGKOO_20100823_END

//NAGSM_Android_HQ_LEESUNGKOO_20100906_START
#if defined(CONFIG_S5PC110_T959_BOARD)
	unsigned char ce147_str_model[9] = "SGH-T959\0";
#endif
//NAGSM_Android_HQ_LEESUNGKOO_20100906_END
