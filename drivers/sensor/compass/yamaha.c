...
#elif defined(CONFIG_S5PC110_T959_BOARD) || defined(CONFIG_S5PC110_SIDEKICK_BOARD)
#define YAMAHA_GSENSOR_TRANSFORMATION_KEPLER    \
    { { 0,  -1,  0}, \
      { -1, 0,  0}, \
      { 0,  0,  -1} }
...
#if defined(CONFIG_S5PC110_KEPLER_BOARD) || defined(CONFIG_S5PC110_FLEMING_BOARD) || defined(CONFIG_S5PC110_T959_BOARD) || defined(CONFIG_S5PC110_SIDEKICK_BOARD)
