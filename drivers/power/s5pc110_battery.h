...
// ]]junghyunseok edit temperature table 20100531
#elif defined CONFIG_S5PC110_SIDEKICK_BOARD
#define EVENT_TEMP_HIGH_BLOCK	temper_table[77][0]		// 65 °À¢ÁE
#define EVENT_TEMP_HIGH_RECOVER	temper_table[65][0]		// 55 °À¢ÁE
#define TEMP_HIGH_BLOCK	temper_table[58][0]		// 45 °À¢ÁE
#define TEMP_HIGH_RECOVER	temper_table[53][0]		// 40 °À¢ÁE
#define TEMP_LOW_BLOCK		temper_table[12][0]		// 0 temp
#define TEMP_LOW_RECOVER	temper_table[13][0]		// 3 temp
#else
...
#if defined(CONFIG_S5PC110_KEPLER_BOARD) || (defined CONFIG_T959_VER_B0) || (defined CONFIG_T959_VER_B5) || defined(CONFIG_S5PC110_SIDEKICK_BOARD) || defined(CONFIG_S5PC110_FLEMING_BOARD)	
	S3C_ADC_EAR = 3,
	S3C_ADC_V_F = 4,
...
#if defined(CONFIG_KEPLER_VER_B2)||  defined(CONFIG_S5PC110_FLEMING_BOARD) || (defined CONFIG_T959_VER_B5) || defined(CONFIG_S5PC110_SIDEKICK_BOARD)
...
#define CURRENT_OF_TOPOFF_CHG		164		//110mA
#else
#define CURRENT_OF_FULL_CHG		279		//150mA
#define CURRENT_OF_TOPOFF_CHG		100		//80mA
#endif
#endif
#endif
...
#if defined(CONFIG_S5PC110_SIDEKICK_BOARD)
#define BATT_VF_MAX	800 
#define BATT_VF_MIN		400
#else
