...
#if 1 //defined(CONFIG_KEPLER_VER_B2) || defined(CONFIG_T959_VER_B5)
    NULL, // TOPOFFR
    NULL, // ONKEY1S
    NULL, // LOBAT2
    NULL// LOBAT1   
...
void maxim_vac_connect(void)
{
	...
	if(Get_MAX8998_PM_REG(VDCINOK_status) && get_usb_cable_state())
	{
...
#if defined(CONFIG_S5PC110_T959_BOARD) || defined(CONFIG_S5PC110_SIDEKICK_BOARD) || defined(CONFIG_S5PC110_HAWK_BOARD) || defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
...
#if 1
             Get_MAX8998_PM_ADDR(CHGR2, &iTemp, 1);
              iTemp = iTemp & 0xC0;  // read for Safeout1, safeout2 
			stepchargingreg_buff[1] = iTemp |(0x3<<4) | (0x0<<3) | (0x0<<1) | (0x0<<0); //ESAFEOUT1,2= 10, FCHG_TMR=Disable, MBAT_REG_TH=4.2V, MBATT_THERM_REG=105C
#else
...
#if defined(CONFIG_S5PC110_KEPLER_BOARD) || defined(CONFIG_S5PC110_T959_BOARD) || defined(CONFIG_S5PC110_SIDEKICK_BOARD) || defined(CONFIG_S5PC110_HAWK_BOARD) || defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD)
              stepchargingCount = 0;
              mod_timer(&chargingstep_timer, jiffies + msecs_to_jiffies(CHARGINGSTEP_INTERVAL));
#else
		stepchargingCount = 0;
...
// 0x0D address
		...
		if(uicharging)
 		...
 		Get_MAX8998_PM_ADDR(CHGR2, &iTemp, 1);
		iTemp = iTemp & 0xC0;  // read for Safeout1, safeout2 	
 	    stepchargingreg_buff[1] = iTemp | (0x3<<4) | (0x0<<3) | (0x0<<1) | (0x0<<0); //ESAFEOUT1,2= 01, FCHG_TMR=disable, MBAT_REG_TH=4.2V, MBATT_THERM_REG=105C
#else
		if(value)
		{
