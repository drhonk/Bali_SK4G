...
#endif
	bh6173_i2c_read(bh6173_client, reg, &val);
#ifndef CONFIG_CPU_FREQ
...
static int bh6173_write_reg(struct bh6173_data *bh6173, u8 value, u8 reg)
{
	...
	bh6173_i2c_write(bh6173_client, reg, value);
#ifndef CONFIG_CPU_FREQ
	mutex_unlock(&bh6173->mutex);
#endif
	return 0;
...
int bh6173_ldo_is_enabled_status(int ldo)
{
	...
	{
	value = bh6173_read_reg(bh6173_client, BH6173GUL_Register_REGCNT);
	shift = ldo;											
	}
	else {
                printk("ERROR: Invalid argument passed\n");
...
int REG_power_onoff(int ONOFF_REG)
{
	...
	u8 value = 0; 
    u8 temp =0;
	bh6173_i2c_read(bh6173_client, BH6173GUL_Register_REGCNT,&value);	//NAGSM_Android_SEL_Kernel_Aakash_20101021
...
//[NAGSM_Android_HDLNC_SeoJW_20101209 : REG_SETTING		
	bh6173_i2c_write(bh6173_client, BH6173GUL_Register_SWADJ, BH6173GUL_SWADJ_180);
	temp &= 0xF0;
	temp |= BH6173GUL_LDO1_280;

	bh6173_i2c_write(bh6173_client, BH6173GUL_Register_LDOADJ1, temp);
	temp &= 0x0F;
	temp |= BH6173GUL_LDO2_180;
	bh6173_i2c_write(bh6173_client, BH6173GUL_Register_LDOADJ1, temp);
	temp = BH6173GUL_LDO3_280;
	bh6173_i2c_write(bh6173_client, BH6173GUL_Register_LDOADJ2, temp);
//[NAGSM_Android_HDLNC_SeoJW_20101209 : REG_SETTING	
	return bh6173_i2c_write(bh6173_client, BH6173GUL_Register_REGCNT, value);
}
...
u8 pulldown_select(u8 reg_ldo, u8 registance)
{
	...
	bh6173_i2c_read(bh6173_client, BH6173GUL_Register_PDSEL,&pdsel);
	...
	return_value =  bh6173_i2c_write(bh6173_client, BH6173GUL_Register_PDSEL, pdsel);
...
u8 powerdown_select(u8 reg_ldo, u8 state)
{
	...
	bh6173_i2c_read(bh6173_client, BH6173GUL_Register_PDCNT,&pdcnt);
	...
	return_value =  bh6173_i2c_write(bh6173_client, BH6173GUL_Register_PDCNT, pdcnt);
				...
				const struct i2c_device_id *i2c_id)
{
	...
	bh6173_i2c_write(bh6173_client, BH6173GUL_Register_SWREGCNT, BH6173GUL_REG_SW_PWMONLY);
	
	bh6173_i2c_write(bh6173_client, BH6173GUL_Register_REGCNT, BH6173GUL_REGCNT_ALL);
