...
#define KEYPAD_COLUMNS	8	// SIDEKICK_KEYPAD
#define KEYPAD_ROWS	8
...
#if (defined(CONFIG_SIDEKICK_VER_B0) || defined(CONFIG_SIDEKICK_VER_B1))
 #define MAX_KEYPAD_NR  64	// SIDEKICK_KEYPAD
 #elif defined(CONFIG_SIDEKICK_VER_B2)
		#define MAX_KEYPAD_NR  63	// SIDEKICK_KEYPAD
 #endif
#else
...
int keypad_keycode[] = {
		...
		25,67,27,28,29,30,31,32,	// 31
		33,34,35,36,37,38,39,40,	// 39
		41,66,43,44,45,46,58/*voldown*/,48,	// 47
		49,68,51,52,53,54,42/*volup*/,56,		// 55
		57,65,59,60,61,62,63,64				// 63
 #elif defined(CONFIG_SIDEKICK_VER_B2)	
 		8,2,3,4,5,6,7,16,		// 7
